...
public record Ammo_338LM : NewItemFromCloneDetails
{
    public override MongoId? ItemTplToClone { get; set; } = ItemTpl.AMMO_86X70_FMJ;
    public override TemplateItemProperties OverrideProperties { get; set; } = new()
    {
        Prefab = new Prefab
        {
            Path = "rifle_us/ammo_338lm_ratshot.bundle"
        },
        Name = "ammo_338lm_xx_rat",
        Damage = 10,
        ProjectileCount = 10,
        BuckshotBullets = 10,
        Weight = 0.075,
    ...
    public override string NewId { get; set; } = ModItemTpl.AMMO_338LM.ToString();
