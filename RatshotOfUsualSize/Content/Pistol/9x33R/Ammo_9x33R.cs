...
public record Ammo_9x33R : NewItemFromCloneDetails
{
    public override MongoId? ItemTplToClone { get; set; } = ItemTpl.AMMO_9X33R_FMJ;
    public override TemplateItemProperties OverrideProperties { get; set; } = new()
    {
        Prefab = new Prefab
        {
            Path = "pistol/ammo_9x33r_ratshot.bundle"
        },
        Name = "ammo_9x33r_xx_rat",
        Damage = 10,
        ProjectileCount = 10,
        BuckshotBullets = 10,
        Weight = 0.075,
    ...
    public override string NewId { get; set; } = ModItemTpl.AMMO_9X33R.ToString();
