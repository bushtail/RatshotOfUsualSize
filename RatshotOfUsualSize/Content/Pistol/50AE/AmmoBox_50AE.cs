...
public record AmmoBox_50AE : NewItemFromCloneDetails
{
    public override MongoId? ItemTplToClone { get; set; } = ItemTpl.AMMOBOX_127X33_FMJ_20RND;
    public override TemplateItemProperties OverrideProperties { get; set; } = new()
    {
        Prefab = new Prefab
        {
            Path = "pistol/ammobox_50ae_ratshot.bundle"
        },
        Name = "ammo_box_50ae_xx_rat",
        StackMaxRandom = 10,
        StackMaxSize = 1,
        StackMinRandom = 10,
        StackObjectsCount = 1,
        ...
        [
            new StackSlot
            {
                Id = "6941a4bf787395b8cc0ab16c",
                Name = "cartridges",
                Parent = ModItemTpl.AMMOBOX_50AE.ToString(),
                MaxCount = 10,
    ...
    public override string NewId { get; set; } = ModItemTpl.AMMOBOX_50AE.ToString();
