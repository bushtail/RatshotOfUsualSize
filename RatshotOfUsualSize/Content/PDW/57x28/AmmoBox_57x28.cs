...
public record AmmoBox_57x28 : NewItemFromCloneDetails
{
    public override MongoId? ItemTplToClone { get; set; } = ItemTpl.AMMOBOX_57X28_SS198LF_50RND;
    ...
    public override string NewId { get; set; } = ModItemTpl.AMMOBOX_57X28.ToString();
