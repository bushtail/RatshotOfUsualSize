...
public record Ammo_762x25TT : NewItemFromCloneDetails
{
    public override MongoId? ItemTplToClone { get; set; } = ItemTpl.AMMO_762X25TT_FMJ43;
    public override TemplateItemProperties OverrideProperties { get; set; } = new()
    {
        Prefab = new Prefab
        {
            Path = "pistol/ammo_762x25tt_ratshot.bundle"
        },
        Name = "ammo_762x25tt_xx_rat",
        Damage = 10,
        ProjectileCount = 10,
        BuckshotBullets = 10,
        Weight = 0.075,
    ...
    public override string NewId { get; set; } = ModItemTpl.AMMO_762X25TT.ToString();
