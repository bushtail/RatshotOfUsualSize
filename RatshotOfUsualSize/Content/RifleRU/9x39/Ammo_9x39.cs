...
public record Ammo_9x39 : NewItemFromCloneDetails
{
    public override MongoId? ItemTplToClone { get; set; } = ItemTpl.AMMO_9X39_FMJ;
    public override TemplateItemProperties OverrideProperties { get; set; } = new()
    {
        Prefab = new Prefab
        {
            Path = "rifle_ru/ammo_9x39_ratshot.bundle"
        },
        Name = "ammo_9x39_xx_rat",
        Damage = 10,
        ProjectileCount = 10,
        BuckshotBullets = 10,
        Weight = 0.075,
    ...
    public override string NewId { get; set; } = ModItemTpl.AMMO_9X39.ToString();
