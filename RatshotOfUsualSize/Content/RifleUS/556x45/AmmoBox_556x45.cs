...
public record AmmoBox_556x45 : NewItemFromCloneDetails
{
    public override MongoId? ItemTplToClone { get; set; } = ItemTpl.AMMOBOX_556X45_FMJ_50RND;
    public override TemplateItemProperties OverrideProperties { get; set; } = new()
    {
        Prefab = new Prefab
        {
            Path = "rifle_us/ammobox_556x45_ratshot.bundle"
        },
        Name = "ammo_box_556x45_xx_rat",
        StackMaxRandom = 10,
        StackMaxSize = 1,
        StackMinRandom = 10,
        StackObjectsCount = 1,
        ...
        [
            new StackSlot
            {
                Id = "6941a509787395b8cc0ab178",
                Name = "cartridges",
                Parent = ModItemTpl.AMMOBOX_556X45.ToString(),
                MaxCount = 10,
    ...
    public override string NewId { get; set; } = ModItemTpl.AMMOBOX_556X45.ToString();
