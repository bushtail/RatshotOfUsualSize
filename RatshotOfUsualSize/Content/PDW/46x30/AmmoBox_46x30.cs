...
public record AmmoBox_46x30 : NewItemFromCloneDetails
{
    public override MongoId? ItemTplToClone { get; set; } = ItemTpl.AMMOBOX_46X30_FMJ_SX_40RND;
    ...
    public override string NewId { get; set; } = ModItemTpl.AMMOBOX_46X30.ToString();
