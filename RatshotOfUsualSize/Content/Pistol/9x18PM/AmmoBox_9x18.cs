...
public record AmmoBox_9x18 : NewItemFromCloneDetails
{
    ...
    public override TemplateItemProperties OverrideProperties { get; set; } = new()
    {
        Prefab = new Prefab
        {
            Path = "pistol/ammobox_9x18_ratshot.bundle"
        },
        Name = "ammo_box_9x18_xx_rat",
        StackMaxRandom = 10,
        StackMaxSize = 1,
        StackMinRandom = 10,
        StackObjectsCount = 1,
        ...
        [
            new StackSlot
            {
                Id = "6941a488787395b8cc0ab165",
                Name = "cartridges",
                Parent = ModItemTpl.AMMOBOX_9X18PM.ToString(),
                MaxCount = 10,
