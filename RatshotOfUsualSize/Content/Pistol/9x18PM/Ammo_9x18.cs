...
public record Ammo_9x18 : NewItemFromCloneDetails
{
    public override MongoId? ItemTplToClone { get; set; } = ItemTpl.AMMO_9X18PM_P;
    ...
    public override string NewId { get; set; } = ModItemTpl.AMMO_9X18PM.ToString();
