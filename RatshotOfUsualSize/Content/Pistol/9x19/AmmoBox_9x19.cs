...
public record AmmoBox_9x19 : NewItemFromCloneDetails
{
    public override MongoId? ItemTplToClone { get; set; } = ItemTpl.AMMOBOX_9X19_M882_50RND;
    public override TemplateItemProperties OverrideProperties { get; set; } = new()
    {
        Prefab = new Prefab
        {
            Path = "pistol/ammobox_9x19_ratshot.bundle"
        },
        Name = "ammo_box_9x19_xx_rat",
        StackMaxRandom = 10,
        StackMaxSize = 1,
        StackMinRandom = 10,
        StackObjectsCount = 1,
        ...
        [
            new StackSlot
            {
                Id = "6941a4a1787395b8cc0ab167",
                Name = "cartridges",
                Parent = ModItemTpl.AMMOBOX_9X19.ToString(),
                MaxCount = 10,
    ...
    public override string NewId { get; set; } = ModItemTpl.AMMOBOX_9X19.ToString();
