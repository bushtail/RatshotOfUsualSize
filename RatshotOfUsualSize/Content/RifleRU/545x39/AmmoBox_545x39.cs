...
public record AmmoBox_545x39 : NewItemFromCloneDetails
{
    public override MongoId? ItemTplToClone { get; set; } = ItemTpl.AMMOBOX_545X39_FMJ_30RND;
    public override TemplateItemProperties OverrideProperties { get; set; } = new()
    {
        Prefab = new Prefab
        {
            Path = "rifle_ru/ammobox_545x39_ratshot.bundle"
        },
        Name = "ammo_box_545x39_xx_rat",
        StackMaxRandom = 10,
        StackMaxSize = 1,
        StackMinRandom = 10,
        StackObjectsCount = 1,
        ...
        [
            new StackSlot
            {
                Id = "6941a4e1787395b8cc0ab172",
                Name = "cartridges",
                Parent = ModItemTpl.AMMOBOX_545X39.ToString(),
                MaxCount = 10,
    ...
    public override string NewId { get; set; } = ModItemTpl.AMMOBOX_545X39.ToString();
