...
public record Ammo_20x1 : NewItemFromCloneDetails
{
    public override MongoId? ItemTplToClone { get; set; } = ItemTpl.AMMO_20X1MM_DISK;
    public override TemplateItemProperties OverrideProperties { get; set; } = new()
    {
        Prefab = new Prefab
        {
            Path = "pistol/ammo_20x1_ratshot.bundle"
        },
        Name = "ammo_20x1_xx_rat",
        Damage = 10,
        ProjectileCount = 10,
        BuckshotBullets = 10,
        Weight = 0.075,
    ...
    public override string NewId { get; set; } = ModItemTpl.AMMO_20X1.ToString();
